...
Jingjing Xu, Xu Sun, **Qi Zeng**, Xiaodong Zhang, Xuancheng Ren, Houfeng Wang and Wenjie Li. "Unpaired Sentiment-to-Sentiment Translation Using Cycled Reinforcement Learning". Submitted to *56th Annual Meeting of the Association for Computational Linguistics* (**ACL 2018**), under review.

Liangchen Luo, Wenhao Huang, Jingtian Jiang, **Qi Zeng**, Zaiqing Nie. "Learning Personalized End-to-End Goal-Oriented Dialog". Subimitted to *27th International Conference on Computational Linguistics* (**COLING 2018**), under review.

Jingjing Xu, Guangxiang zhao, Xu Sun, **Qi Zeng**. "Review-Driven Multi-Label Music Style Classification by Exploiting Style Correlations". Subimitted to *27th International Conference on Computational Linguistics* (**COLING 2018**), under review.
